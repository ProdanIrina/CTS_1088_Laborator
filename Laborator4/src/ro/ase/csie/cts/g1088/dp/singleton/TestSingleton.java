...
public class TestSingleton {
	...
	public static void main(String[] args) {
		...
		ConexiuneBD conexiune1 =  ConexiuneBD.getContexiune();
		ConexiuneBD conexiune2 =  ConexiuneBD.getContexiune();
		
		if(conexiune1 == conexiune2) {
			System.out.println("Cele 2 referinte sunt indentice");
		}
		else {
			System.out.println("Cele 2 referint sunt diferite");
		}
